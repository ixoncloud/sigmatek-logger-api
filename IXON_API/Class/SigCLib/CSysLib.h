 ...
 #define _CSysLibH
  ...
  #include "DefineCompiler.h"
    ...
    // delay thread us
    cExtern void sigclib_thread_delay_us(unsigned long duration);
    ...
    // delay thread us
    function global __cdecl sigclib_thread_delay_us var_input duration:udint; end_var;
...
// <-- function will return valid this-pointer when named object is existing, on the other hand NULL
